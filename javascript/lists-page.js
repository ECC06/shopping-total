...
listsCont.addEventListener("click", (e) => {
    if (e.target.className === "open-btn") {
        ...
        const lastOpenedElem = listCont.querySelector("#modified-date");
        ...
        //stores the date the open button was clicked (i.e the day the user modified the list)
        function storeLastOpened() {
            ...
            localStorage.setItem(
                "lists",
                JSON.stringify(listsFromLocalStorage),
            );
        }
    }
});
